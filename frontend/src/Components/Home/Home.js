  ...
  return (
    <div className="home-container">
      ...
      <div className="ser">
          ...
          <div>
            ...
            <div className="description_h3">
              <p>
                ...
                operational segments by offering a range of ICT solutions that
                cater to consumers with a digital lifestyle including Voice,
                Fiber, ADSL, 4G LTE, Cloud Services, Enterprise Solutions,
                wholesale, international ICT solutions, IPTV services,
                eChannelling and a host of Value-added services. In its journey
                of transformation into a digital service provider, SLT-MOBITEL
                has expanded beyond ICT services to deliver products and
                services that utilize its core strengths.
              </p>
            </div>
          </div>
        ...
        {/* Image Gallery */}
        <section className="image-gallery_h">
      ...
      <section className="feedback">
        ...
        <div className="image-container">
          ...
          <div className="fdImage">
            <img src={f4} className="ab3" alt="Feedback 3" />
          </div>
        </div>
